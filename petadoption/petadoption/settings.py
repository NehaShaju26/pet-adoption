...
SECRET_KEY = 'django-insecure-h9x#!-cpoz5@7+--#%$q_)mwj-lehm9bg*e3_z%lizdzrdz9nb'
...
# Additional directories to look for static files (e.g., inside apps or a 'static' folder)
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
