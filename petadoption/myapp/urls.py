...
urlpatterns = [
    ...
    path('login/', views.pet_login,name="log_in"),
    path('logout/', views.pet_logout,name="log_out"),
    ...
    path('view-pet-details', views.view_pet_detail, name='view_pet_details'),
    ...
    path('pet-detail/<int:pet_id>', views.pet_detail, name='pet_details'),
